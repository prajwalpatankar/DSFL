/*============================================================================
 ...
 BATCH         	   : G-10
 ASSIGNMENT NO.	   : 6
 PROBLEM STATEMENT : CONSIDER A FRIENDS ETWORK ON A SOCIAL WEBSITE. MODEL IT
 	 	 	 	 	 AS A GRAPH TO REPRESENT EACH NODE AS A USER AND A LINK
 	 	 	 	 	 TO REPRESENT FRIEND RELATIONSHIP BETWEEN THEM. STORE
 	 	 	 	 	 DATA SUCH AS DATE OF BIRTH, NUMBER OF COMMENTS,ETC.
 	 	 	 	 	 (1)FIND WHO IS HAVING MAXIMUN NUMBER OF FRIENDS.
 	 	 	 	 	 (2)WHO HAS POSTED MAXIMUM AND MINIMUM NUMBER OF COMMENTS.
 	 	 	 	 	 (3)FIND THE USERS HAVING BIRTHDAY THIS MONTH.
 ============================================================================*/
#include <iostream>
#include <queue>
using namespace std;
